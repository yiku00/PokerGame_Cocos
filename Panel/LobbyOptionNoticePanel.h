/********************************************************************
file name:	LobbyOptionNoticePanel.h
...
class LobbyOptionNoticePanel : public Panel, public Button::Listener, public Nx::Layer::Listener
{
public:
	LobbyOptionNoticePanel();
	virtual ~LobbyOptionNoticePanel();
